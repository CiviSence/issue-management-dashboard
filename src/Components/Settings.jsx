  ...
  const ToggleSwitch = ({
    ...
    <div className="flex items-center justify-between p-4 sm:p-5 rounded-2xl bg-gray-50/70 border border-gray-100 hover:border-violet-200/60 transition-all group">
      <div className="flex items-start gap-3.5 pr-4">
        <div className="shrink-0 mt-0.5 text-gray-700 transition-transform group-hover:scale-110">
        ...
        <div>
          ...
          {currentCategory === "list" && (
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-100 shadow-xs overflow-hidden divide-y divide-gray-100">
                {categories.map((cat) => (
                  <button
                    key={cat.id}
                    type="button"
                  ...
                  >
                    <div className="flex items-center gap-4 sm:gap-5 pr-4">
                      <div className="w-8 flex items-center justify-center shrink-0 text-gray-700 transition-transform group-hover:scale-110 group-hover:text-gray-900">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-gray-50 group-hover:bg-gray-100 flex items-center justify-center text-gray-400 group-hover:text-gray-800 shrink-0 transition-all">
              ...
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 flex items-center justify-between flex-wrap gap-4">
          ...
          {currentCategory !== "list" && (
            <div className=" animate-fadeIn">
              ...
              {currentCategory === "account" && (
                <div className="bg-white  border border-gray-100 shadow-xs p-6 sm:p-8 space-y-6">
                  <h3 className="font-bold text-gray-900 text-lg border-b border-gray-100 pb-3">
                    <button
                      type="button"
                      onClick={navigateToList}
                      className="inline-flex text-gray-700 font-bold text-sm mr-2 transition active:scale-95"
                    >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 text-lg">
                          {profileData?.name || "Member Account"}
                        </h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    <div className="p-4 rounded-2xl border border-gray-100 bg-gray-50/50 space-y-1">
                      ...
                      <p className="text-xs text-gray-700 font-medium flex items-center gap-1 mt-1">
                        <i className="ri-verified-badge-fill text-gray-700"></i>{" "}
                  ...
                  <div className="mt-8 p-6 rounded-2xl border border-red-200 bg-red-50/40 space-y-4">
                    <div className="flex items-center gap-2 text-red-700 font-bold text-lg">
                      <i className="ri-error-warning-fill text-xl text-gray-700"></i>
                    ...
                    <div className="p-4 rounded-xl bg-red-100/60 border border-red-200 text-red-800 text-xs sm:text-sm leading-relaxed">
                      ...
                      All user data including issues, comments, and votes will
                      be preserved but attributed to a deleted user.
                    </div>

                    <p className="text-xs sm:text-sm text-red-700 font-medium">
                      Delete user account permanently. Please enter your current
                      password for verification.
                    </p>

                    <form
                      onSubmit={handleDeleteAccount}
                      className="space-y-3 max-w-md pt-1"
                    >
                      <div>
                ...
                <div className="bg-white border border-gray-100 shadow-xs p-6 sm:p-8 space-y-6">
                  ...
                  <div className="space-y-2 max-w-lg">
                    ...
                    >
                      ...
                      <option value="daily">
                        Daily Digest (Delivered every morning at 8:00 AM)
                      </option>
                      <option value="weekly">
                        Weekly Summary (Delivered on Monday mornings)
                      </option>
              ...
              {currentCategory === "security" && (
                <div className="bg-white border border-gray-100 shadow-xs p-6 sm:p-8 space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-gray-50 border border-gray-200/70 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center justify-center shrink-0 text-gray-700">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Last changed 45 days ago • Encrypted with bcrypt
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  <div className="space-y-3">
                    <div className="p-4 rounded-xl border border-emerald-200 bg-emerald-50/30 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <i className="ri-computer-line text-xl text-gray-700"></i>
                        <div>
                          <p className="font-bold text-sm text-gray-900">
                            Windows PC • Chrome Browser
                          </p>
                          <p className="text-xs text-emerald-600 font-medium">
                            Current Active Session • IP: 192.168.1.45
                          </p>
                        </div>
                      </div>
              ...
              {currentCategory === "data" && (
                <div className="bg-white border border-gray-100 shadow-xs p-6 sm:p-8 space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-gray-50 border border-gray-200/70 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <h4 className="font-bold text-gray-900 text-base flex items-center gap-2">
                        <i className="ri-hard-drive-2-line text-gray-700 text-lg"></i>
                        Application Cache Size: ~14.8 MB
                      </h4>
                      <p className="text-xs text-gray-500 mt-1">
                        Includes cached issue images, offline drafts, and user
                  ...
                  <div className="p-5 rounded-2xl bg-gray-50 border border-gray-200/70 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <h4 className="font-bold text-gray-900 text-base flex items-center gap-2">
                        <i className="ri-file-download-line text-gray-700 text-lg"></i>
                        Download Activity Report
                      </h4>
                      <p className="text-xs text-gray-500 mt-1">
                        Get a complete CSV or JSON file containing your reported
                        issues, comments, and reputation log.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="p-5 rounded-2xl border border-amber-200 bg-amber-50/40 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs text-amber-700 mt-0.5">
                        Restores Light theme, daily digest notifications,
                        comfortable density, and default sorting.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        <div className="flex items-center justify-center text-gray-700">
                          <i className="ri-file-shield-line text-2xl"></i>
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900 text-base group-hover:text-violet-600 transition-colors">
                            Privacy Policy
                          </h4>
                          <p className="text-xs text-gray-500 mt-0.5">
                      ...
                      <i className="ri-arrow-right-up-line text-xl text-gray-400 group-hover:text-gray-700 transition-colors"></i>
                    </Link>
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 text-base group-hover:text-amber-600 transition-colors">
                            Help & Support
                          </h4>
                          <p className="text-xs text-gray-500 mt-0.5">
                            FAQs & contact desk
