    ...
    <div className="bg-white dark:bg-dark-card  p-5 rounded-2xl shadow-xs flex flex-col items-center">
      ...
      <div className="relative w-full flex justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <span className="text-xs text-muted-foreground font-medium mt-0.5 dark:text-dark-text-secondary">
            Issues Resolved
          </span>
        </div>
      </div>
      ...
      <div className="flex gap-6 mt-1">
        <div className="text-center">
          <span className="text-xs text-muted-foreground block dark:text-dark-text-secondary">Resolved</span>
          <span className="text-lg font-bold text-emerald-600">{resolved}</span>
        </div>
        <div className="w-px bg-border"></div>
        <div className="text-center">
          <span className="text-xs text-muted-foreground block dark:text-dark-text-secondary">Total</span>
