        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {activeTab === "profile" ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Avatar Preview Section - Available for all roles */}
              ...
              {/* Phone Number - Available for all roles */}
              <InputField
                label="Phone Number"
                name="phone_number"
              ...
              {/* Admin has minimal editable fields (just name, phone, and avatar) */}
            </div>
          ) : (
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-violet-500 hover:bg-violet-700 text-white rounded-lg font-medium shadow-md transition disabled:opacity-70"
              disabled={loading || uploading}
            >
              {loading
                ? "Saving..."
