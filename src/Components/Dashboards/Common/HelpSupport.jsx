  ...
  const faqs = [
    {
      ...
      answer:
        "Go to your dashboard or the reported issues page and click on 'Report Issue'. Fill in the details and submit.",
    },
    {
      question: "Can I track the status of my reported issue?",
      answer:
        "Yes, you can track the status in the 'My Dashboard' or 'Reported Issues' section.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Your reported issues are visible to the administration and staff. Public issues may be visible to other students depending on the settings.",
    },
  ];
          ...
          {activeTab === "contact" && (
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 mb-6">
                If you couldn't find your answer in the FAQs, feel free to reach
                out to us directly.
              </p>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:border-violet-600 focus:ring-1 focus:ring-violet-600"
